...
[<assembly: AssemblyTitleAttribute("FunConcurrency.Tests")>]
[<assembly: AssemblyProductAttribute("FunConcurrency")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FunConcurrency.Tests"
    let [<Literal>] AssemblyProduct = "FunConcurrency"
