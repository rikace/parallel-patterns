...
namespace GraphTasksConsumer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var dm = new TaskDirectGraphDependencies();
            dm.AddOperation(1, () => action(1, 600), 4, 5);
            dm.AddOperation(2, () => action(2, 200), 5);
            dm.AddOperation(3, () => action(3, 800), 6, 5);
            dm.AddOperation(4, () => action(4, 500), 6);
            dm.AddOperation(5, () => action(5, 450), 7, 8);
            dm.AddOperation(6, () => action(6, 100), 7);
            dm.AddOperation(7, () => action(7, 900));
            dm.AddOperation(8, () => action(8, 700));
            dm.Execute();
