...
namespace Shared.Reactive.Tweets
{
    public class Tweet : ITweet
    {
        ...
        public string Text { get => _dto["text"].ToString(); set => throw new NotImplementedException(); }
        ...
        public ICoordinates Coordinates
        {
            get
            {
                ...
                if (token != null)
                {
                    return new Coordinates(double.Parse(token["Latitude"].ToString()), double.Parse(token["Longitude"].ToString()));
                }
                else
                {
                    return null;
    ...
    public class User : IUser
    {
        ...
        public string ScreenName { get => _dto["screen_name"].ToString(); set => throw new NotImplementedException(); }
