...
namespace DataflowPipeline
{
    public class DataflowPipeline
    {
        ...
        public static void Start()
        {
            ...
            // TODO : 5.6
            // implement a pipeline that downloads a given text-file
            // and then process its content
            // use the Dataflow building blocks that match the previous 
            // generic delegates.
            //
            // Then link the blocks to generate the pipeline
            // The last step of the pipeline should be using Reactive Extensions
            ...
            // TODO 
            // pass the "opt" ExecutionDataflowBlockOptions for each of the created
            // Dataflow building blocks, then, increment the level of parallelism.
